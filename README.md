...
| GET    | `/users`                                               | all users      | Searches for students via a query string                                                                                                                                                  |
| GET    | `/users/:userId`                                       | all users      | Returns a user object with a progress property indicating completion of all user requirements, as well as a coach property indicating if the the user is pinned by a coach                |
